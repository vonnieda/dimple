...
use dimple_core::{collection::Collection, model::{Artist, Entities, Recording, Release, ReleaseGroup}};
...
fn artist_links(artist: &Artist) -> Vec<Link> {
    artist.links
        ...
        .chain(std::iter::once(Link { 
            name: format!("https://musicbrainz.org/artist/{}", artist.key.str()),
            url: format!("https://musicbrainz.org/artist/{}", artist.key.str()),
        }))
        .collect()
}
...
fn release_group_links(release_group: &ReleaseGroup) -> Vec<Link> {
    release_group.links
        ...
        .chain(std::iter::once(Link { 
            name: format!("https://musicbrainz.org/release-group/{}", release_group.key.str()),
            url: format!("https://musicbrainz.org/release-group/{}", release_group.key.str()),
        }))
        .collect()
}
...
fn release_links(release: &Release) -> Vec<Link> {
    release.links
        ...
        .chain(std::iter::once(Link { 
            name: format!("https://musicbrainz.org/release/{}", release.key.str()),
            url: format!("https://musicbrainz.org/release/{}", release.key.str()),
        }))
        .collect()
}
...
fn recording_links(recording: &Recording) -> Vec<Link> {
    recording.links
        ...
        .chain(std::iter::once(Link { 
            name: format!("https://musicbrainz.org/recording/{}", recording.key.str()),
            url: format!("https://musicbrainz.org/recording/{}", recording.key.str()),
        }))
        .collect()
}
